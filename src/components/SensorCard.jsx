...
import StatusBadge from "./AIBadge";
  ...
  return (
    <motion.article
      ...
      style={{
        ...
        border: `1px solid ${status === "critical" ? sc.border : "#1e293b"}`,
        boxShadow: status === "critical"
          ? `0 0 24px ${sc.border}44, 0 4px 24px rgba(0,0,0,0.5)`
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "12px" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div>
            <div style={{ fontSize: "13px", fontWeight: 600, color: sensor.color, fontFamily: "'DM Mono', monospace" }}>
              {sensor.label}
            </div>
      ...
      <div style={{ display: "flex", justifyContent: "center" }}>
        <RadialGauge sensor={sensor} value={value} anomaly={status === "critical"} />
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "center", marginBottom: "12px" }}>
        <motion.div
          ...
          animate={status === "critical" ? { scale: [1, 1.06, 1] } : {}}
